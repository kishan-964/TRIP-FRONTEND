    ...
    <main className="px-20 py-8">
      <Card>
        <CardHeader className="border-b">
          ...
          <CardDescription>Show all My bookings for trip.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableCaption>A list of My recent bookings.</TableCaption>
            <TableHeader>
              <TableRow>
                ...
                data.map((booking, index) => {
                  return (
                    <TableRow key={booking._id}>
                      ...
                      <TableCell>
                        <span
                          className={` ${badgeColor(booking.status)} text-white px-4 py-1 rounded-full uppercase`}
                        >
                          {booking.status}
                        </span>
                      </TableCell>
